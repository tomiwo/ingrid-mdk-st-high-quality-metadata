...
htmlhelp_basename = 'qualitativ-hochwertige-metadaten-erfassen-und-pflegen'
...
texinfo_documents = [
    (master_doc, 'leitfaden-metadaten', 'qualitativ-hochwertige-metadaten-erfassen-und-pflegen',
     author, 'Torsten Wolff', 'One line description of project.',
     'Miscellaneous'),
]
